...
Sreeram App ("us", "we", or "our") operates the ${config.seo.domain} website and the Sreeram App mobile application (the "Service").

This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Sreeram App is based on the [Free Privacy Policy Template Website](https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/).
...
Sreeram App uses the collected data for various purposes:
...
Sreeram App may disclose your Personal Data in the good faith belief that such action is necessary to:

*   To comply with a legal obligation
*   To protect and defend the rights or property of Sreeram App
